#!/usr/bin/env python3
"""
Extract PDF and save detailed output to file.
"""
...
if __name__ == "__main__":
    ...
    print(f"⚙️  Model: yolox (hi_res strategy)\n")
    ...
    output_file = output_dir / "unstructured_yolox_detailed.txt"

    with open(output_file, "w", encoding="utf-8") as f:
        f.write("="*80 + "\n")
        f.write(f"UNSTRUCTURED.IO EXTRACTION OUTPUT\n")
    ...
    json_file = output_dir / "unstructured_yolox_extraction.json"
