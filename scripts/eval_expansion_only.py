...
OUTPUT_PATH = "/app/results/eval_expansion_only_k100.json"
K = 100
USE_HYDE = False
NUM_EXPANDS = 2
...
async def main():
    ...
    print("\nStarting evaluation (Expansion only, no HyDE)...\n")
    results = []
    successful = 0
    ...
    print("\n" + "=" * 80)
    print("EVALUATION SUMMARY (Expansion only)")
    print("=" * 80)
